...
def build_prompts(event, year, ts_start, ts_end, kpis, fiches, truncated,
    ...
    system = (
        ...
        "- prochaines_24h : mini-briefing en 3 a 6 puces des jalons "
        "strategiques (depart de course, ouvertures et fermetures public, "
        "briefings, montages majeurs). Donne les heures (format 14h30). "
        "'Aucun jalon planifie dans les 24 prochaines heures.' si liste vide.\n"
        "\n"
        "Comparaisons :\n"
