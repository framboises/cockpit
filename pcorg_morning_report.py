...
EXTRA_FOCUS_NOTE_NIGHT = (
    ...
    "4. RECOMMANDATIONS : croise systematiquement les constats de cette "
    ...
    "publiques, briefings, depart de course). Si le pic du jour est "
    "attendu en hausse > 10 % vs annee precedente, ajoute une "
    "recommandation explicite de vigilance sur les zones a risque.\n"
)
